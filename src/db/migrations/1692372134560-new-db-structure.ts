...
export class NewDbStructure1692372134560 implements MigrationInterface {
    name = 'NewDbStructure1692372134560'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "employee" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "phone" character varying NOT NULL, "joining_date" character varying NOT NULL, "experience" integer NOT NULL, "status" character varying NOT NULL, "department_id" integer, "role_id" integer, "referred_by_id" integer, CONSTRAINT "UQ_817d1d427138772d47eca048855" UNIQUE ("email"), CONSTRAINT "REL_94f5ee8ab01e6f404378b33456" UNIQUE ("referred_by_id"), CONSTRAINT "PK_3c2bc72f03fd5abbbc5ac169498" PRIMARY KEY ("id"))`);
